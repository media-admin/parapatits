...
function parapatits_register_styles()
{
  ...
  wp_register_style(
    "styles",
    get_template_directory_uri() . "/styles.c0eb9b412b450fe4bb20.css"
  );
...
function parapatits_register_scripts()
{
  ...
  wp_register_script(
    "main",
    get_template_directory_uri() . "/main.c0eb9b412b450fe4bb20.js",
    "",
    null,
    true
  );
  ...
  wp_register_script(
    ...
    get_template_directory_uri() .
      "/assets/vendor/lightbox2/dist/js/lightbox.js",
    "",
    null,
    true
  );
  ...
  wp_register_script(
    "vendors",
    get_template_directory_uri() . "/vendors.b86e0341894c80fe39c1.js",
    "",
    null,
    true
  );
  ...
  */
  ...
  wp_register_script(
    "rellax",
    get_template_directory_uri() . "/assets/scripts/rellax.min.js",
    "",
    null,
    true
  );
  ...
  wp_register_script(
    "button-back-to-top",
    get_template_directory_uri() . "/assets/scripts/button-back-to-top.js",
    "",
    null,
    true
  );
...
add_action(
  ...
  "parapatits_preview_thumb_column",
  10,
  2
);
...
function my_acf_init()
{
  acf_update_setting(
    "google_api_key",
    "AIzaSyAzkr3qs7g4-R6ShYWXKiJ5JZ_i5orikC8"
  );
}
