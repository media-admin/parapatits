		...
		<div class="site-content">
			<section class="site-intro box--left-aligned unstacked-wrapper">
				...
				<div class="unstacked-right">
					<img class="img--centered lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/jobs/cut-for-web_highres-21-DSC03424_web.jpg" alt="Kleinstrukturierter Familienbetrieb">
				</div>
			</section>
			...
			<section class="box--centered unstacked-wrapper">
				...
				<div class="unstacked-right">
					<img class="img--fullwidth lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/jobs/cut-for-web_highres-29-DSC03529_web.jpg" alt="Werde ein Teil unserer familiären Mannschaft!">
				</div>
			</section>
