  ...
  class Navwalker extends Walker_Nav_Menu {
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
      $indent = str_repeat( "\t", $depth );
        $output .= $indent."<li class=\"navbar-item start_lvl";
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ( ! $args['has_children'] ) {//if doesn't have children
        ...
        $item_output .= $indent . '<li class="navbar-item has-dropdown is-hoverable navbar-item--submenu-button" data-target="dropdown"><ul class="navbar-item__submenu"><!-- START DROPDOWN-->' . "\n";
          if ( ! empty( $fa ) ) {//if fa  is not empty
            $item_output .= '<li class="navbar-item"><a' . $class_names . $attributes . '><i class="' . $fa . '"></i>';
            ...
            $item_output .= '<li class="navbar-item"><a' . $class_names . $attributes . $id . '>';//output standard
          }
