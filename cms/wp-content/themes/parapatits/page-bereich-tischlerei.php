		...
		<div class="site-content">
			<section class="site-intro box--left-aligned unstacked-wrapper">
				<div class="unstacked-left">
					<article class="wrapper entrance-fade-right">
				...
				<div class="unstacked-right">
					<div class="img--wood-square-before-red">
						<img id="jumping-img" class="img--centered img--wood-square-before lazyload entrance-fade-center" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/tischlerei/cut-for-web_highres-5-26490815358_55c0a42b07_o_web.jpg" alt="Wohlfühlräume mit Herz">
					</div>
				</div>
			</section>
			...
			<section class="box--right-aligned unstacked-wrapper">
				<div class="unstacked-right unstacked-right--content">
					<article class="wrapper content-wrapper">
						<h2 class="h2__heading entrance-fade-bottom">Alles beginnt mit einer Idee ...</h2>
						<p class="entrance-fade-bottom">
				...
				<div class="unstacked-left">
					<img class="img--right-aligned lazyload rellax" data-rellax-speed="-2" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/tischlerei/cut-for-web_highres-8-DOC002_web.jpg" alt="Idee">
				</div>
			</section>
			...
			<section class="box--left-aligned unstacked-wrapper">
				<div class="unstacked-left unstacked-left--content">
					<article class="wrapper content-wrapper">
						<h2 class="h2__heading entrance-fade-bottom">gefolgt von viel Planung …</h2>
						<p class="entrance-fade-bottom">
				...
				<div class="unstacked-right">
					<img class="img--left-aligned lazyload rellax" data-rellax-speed="-2" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/tischlerei/cut-for-web_highres-7-Pallisch-Kueche-1_gerade_web.jpg" alt="Visualisierung und Planung">
				</div>
			</section>
			...
			<section class="box--right-aligned unstacked-wrapper">
				<div class="unstacked-right unstacked-right--content">
					<article class="wrapper content-wrapper">
						<h2 class="h2__heading entrance-fade-bottom">und einer perfekten Umsetzung.</h2>
						<p class="entrance-fade-bottom">
				...
				<div class="unstacked-left">
					<img class="img--left-aligned lazyload rellax" data-rellax-speed="-2" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/tischlerei/cut-for-web_highres-26-DSC03479_web.jpg" alt="Durchführung und Montage">
				</div>
			</section>
			...
			<section class="box--centered">
					<div class="unstacked-left">
						<img class="img--fullwidth lazyload rellax" data-rellax-speed="-2" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/tischlerei/cut-for-web_highres-20-DSC03422_web.jpg" alt="Erfahrung und Präzision">
					</div>
			</section>
