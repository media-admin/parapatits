			...
			<div class="site-header__branding">
				<div class="site-header__logo">
					<a class="header-logo__link wrapper" href="<?php echo get_home_url(); ?>">
						<img class="site-header__logo-img lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/logos/logo_parapatits-peter-neutral.svg" alt="Logo Paraptits Peter">
					</a>
				</div>
			</div>
