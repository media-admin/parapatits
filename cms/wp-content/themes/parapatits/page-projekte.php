							...
							<div class="search-area">
									...
									<section id="project">
										...
										<ul class="project-filter">
											<li class="list project-filter-active" data-filter="alle">Alle</li>
											<li class="list" data-filter="kueche">Küchen</li>
											<li class="list" data-filter="terrasse">Terrassen</li>
											<li class="list" data-filter="wintergarten">Wintergärten</li>
											<li class="list" data-filter="carport">Carports</li>
										</ul>
										...
										<div class="project-container">
											...
											<!-- box-1 (about-app) ----------------------->
											<a class="project-box kueche" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/30370843820_b14aa5d064_o_web.jpg">
												<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/30370843820_b14aa5d064_o_web.jpg" alt="work">
											</a>

											<!-- box-2 (about-website) ----------------------->
											<a class="project-box terrasse" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/39464746535_2bcc63c4c1_o_web.jpg">
												<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/39464746535_2bcc63c4c1_o_web.jpg" alt="work">
											</a>

											<!-- box-3 (about-ai) ----------------------->
											<a class="project-box kueche" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/39651287294_14b3c2e283_o_web.jpg">
												<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/39651287294_14b3c2e283_o_web.jpg" alt="work">
											</a>

											<!-- box-4 (about-design) ----------------------->
											<a class="project-box wintergarten terrasse" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/DSC01559-2_web.jpg">
												<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/DSC01559-2_web.jpg" alt="work">
											</a>

											<!-- box-5 (about-design) ----------------------->
											<a class="project-box carport" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/Koch 1_web.jpg">
												<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/Koch 1_web.jpg" alt="work">
											</a>

											<!-- box-6 (about-app) ----------------------->
											<a class="project-box kueche" data-lightbox="work" href="<?php bloginfo( 'template_directory' ); ?>/assets/images/tischlerei/projekte/parapatits-tischlerei_komp-38-DSC03459_web.jpg">
										...
										<div id="loadMore" class="btn btn--red btn--centered-aligned">Weitere Projekte laden</div>
									</section>
								</div>
						</div>
					</article>
