			...
			<section class="site-intro box--left-aligned unstacked-wrapper">
				...
				<div class="unstacked-right">
					<div class="img--wood-square-before-gray">
						<img id="jumping-img" class="img--centered img--wood-square-before lazyload" src="<?php bloginfo( 'template_directory' ); ?>/assets/images/bestattung/bestattung/cut-for-web_highres-18-DSC03400_web.jpg" alt="Persönliche Bestattung">
					</div>
				</div>
			</section>
