	...
	<div class="site-content">
		<section class="site-intro box--left-aligned">
			<article class="wrapper">
				<h1 class="site-title h1__title">Impressum</h1>
				<p class="">
		...
		<section class="site-intro box--left-aligned">
			<article class="wrapper">
				<div class="box--left-aligned">
					...
					<button class="btn btn--red btn--centered-aligned" type="button" onklick="window.open('/jobs.html', '_blank')">Jobdetails anzeigen</button>
				</div>
			</article>
		</section>
